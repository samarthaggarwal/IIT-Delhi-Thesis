...
\usepackage{hhline}
\RequirePackage{latexsym,amsmath,amsthm,amssymb,bm}
...
\advisor{Prof. Mausam and Prof. Soumen Chakrabarti}
...
\hspace*{-0.25in}
\parbox{6.4in}{
\noindent {\bf Prof.~Mausam \hfill Prof.~Soumen Chakrabarti} \\
\noindent {Professor \hfill Professor} \\
\noindent {Dept. of Computer Science \hfill Dept. of Computer Science}\\
\noindent {IIT-Delhi, 110016 \hfill IIT-Bombay, 400076}\\
}
\hspace*{1.0in}
\end{singlespacing}
\vspace*{0.25in}\\
